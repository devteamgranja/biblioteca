...
<body class="wide comments example">
	...
	<div class="fw-container">
		<div class="fw-header">
			<div class="nav-ct">
				<a href="https://cloudtables.com/blog/2021/colors">
				<div>
					<img src="/media/images/cloudtables.svg" alt="CloudTables"> No-code DataTables, with full editing.<br>
					New: Introducing colored records to spice up your data.
				</div></a>
			</div>
		...
		<div class="fw-body">
			<div class="content">
				<h1 class="page_title">HighCharts Integration</h1>
				<div class="info">
					<p>This example shows how to integrate the excellent <a href="https://www.highcharts.com/">HighCharts</a> library into your project along-side DataTables. As
					you modify the table by filtering it, the chart is updated automatically to reflect the state of the table.</p>
					<p><a href="/extensions/searchpanes">SearchPanes</a> is also used here to show its integration with DataTables' filtering. For more information take a look at
					the <a href="/blog/2020-09-01.html">blog post on highcharts</a>.</p>
				</div>
				<div class="demo-html">
		...
		return {
			...
			y: val,
						...
						<ul>
							...
							<li>
								<a href="https://cdn.datatables.net/1.11.4/js/jquery.dataTables.min.js">https://cdn.datatables.net/1.11.4/js/jquery.dataTables.min.js</a>
							</li>
							<li>
								<a href=
								"https://cdn.datatables.net/searchpanes/1.4.0/js/dataTables.searchPanes.min.js">https://cdn.datatables.net/searchpanes/1.4.0/js/dataTables.searchPanes.min.js</a>
							</li>
							<li>
								<a href=
								"https://cdn.datatables.net/select/1.3.4/js/dataTables.select.min.js">https://cdn.datatables.net/select/1.3.4/js/dataTables.select.min.js</a>
							</li>
							<li>
								<a href="//code.highcharts.com/highcharts.js">//code.highcharts.com/highcharts.js</a>
							</li>
						</ul>
					</div>
					<div class="table">
					...
					<div class="css">
						...
						<ul>
							<li>
								<a href="https://cdn.datatables.net/1.11.4/css/jquery.dataTables.min.css">https://cdn.datatables.net/1.11.4/css/jquery.dataTables.min.css</a>
							</li>
							<li>
								<a href=
								"https://cdn.datatables.net/searchpanes/1.4.0/css/searchPanes.dataTables.min.css">https://cdn.datatables.net/searchpanes/1.4.0/css/searchPanes.dataTables.min.css</a>
							</li>
							<li>
								<a href=
